<template>
  <div class="UploadPersonaLayout">
    ...
    <label-form className="q-mt-sm" textLabel="Declaração IRPJ" helperText=".jpg, .png, .pdf — até 5MB">
    ...
    <label-form className="q-mt-sm" textLabel="Faturamento dos últimos 9 meses" helperText=".jpg, .png, .pdf — até 5MB">
      <div class="row q-gutter-sm q-mt-xs" style="margin-top: 0; align-items: center">
        <q-btn
          label="Upload"
          color="primary"
    ...
    <label-form className="q-mt-sm" textLabel="Extrato bancário dos útimos 9 meses" helperText=".jpg, .png, .pdf — até 5MB">
      <div class="row q-gutter-sm q-mt-xs" style="margin-top: 0; align-items: center">
        <q-btn
          label="Upload"
          color="primary"
    ...
    <label-form className="q-mt-sm" textLabel="Comprovante de Endereço da Empresa" helperText=".jpg, .png, .pdf — até 5MB">
      <div class="row q-gutter-sm q-mt-xs" style="margin-top: 0; align-items: center">
        <q-btn
          label="Upload"
          color="primary"
