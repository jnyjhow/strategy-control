<template>
  <div class="UploadPersonaLayout">
    ...
    <label-form className="q-mt-sm" textLabel="Declaração IRPJ"> </label-form>
    ...
    <label-form className="q-mt-sm" textLabel="Pro Labore"> </label-form>
    <div class="row q-gutter-sm justify-between q-mt-xs">
      <q-btn
        label="Upload"
        color="primary"
    ...
    <label-form className="q-mt-sm" textLabel="Faturamento dos últimos 9 meses"> </label-form>
    <div class="row q-gutter-sm justify-between q-mt-xs">
      <q-btn
        label="Upload"
        color="primary"
    ...
    <label-form className="q-mt-sm" textLabel="Extrato bancário dos útimos 9 meses"> </label-form>
    <div class="row q-gutter-sm justify-between q-mt-xs">
      <q-btn
        label="Upload"
        color="primary"
    ...
    <label-form className="q-mt-sm" textLabel="PGDAS"> </label-form>
    <div class="row q-gutter-sm justify-between q-mt-xs">
      <q-btn
        label="Upload"
        color="primary"
    ...
    <label-form className="q-mt-sm" textLabel="Comprovante de Endereço da Empresa"> </label-form>
    <div class="row q-gutter-sm justify-between q-mt-xs">
      <q-btn
        label="Upload"
        color="primary"
